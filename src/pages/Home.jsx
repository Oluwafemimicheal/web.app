...
const Home = () => {
  return (
    <div className="flex flex-col gap-2 h-full px-2 overflow-hidden">
      <div>
        <div className="flex justify-left items-center mb-5">
          <div className="flex items-center gap-5 py-1 rounded-sm">
            <NavLink
              to="/"
              className={({ isActive }) => isActive ? "pb-0.5 border-b-2 border-blue-800 text-sky-800" : ""
              }
            >
              Today
            </NavLink>
        ...
        <div className="w-full h-auto flex flex-col gap-3 rounded-lg overflow-hidden">
          ...
          <div className="flex flex-col gap-3">
            <div className="w-full h-auto bg-blue-200 rounded-md">
              <div className="flex flex-col p-5 pb-10 gap-1">
                <h1 className="text-gray-900 mb-3 font-bold">Bible Daily Word</h1>
                <p>The LORD is my strength and my shield; my heart trusts in Him, and I am helped</p>
              </div>
            </div>
          </div>
        </div>
